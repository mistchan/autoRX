...
"""
import win32api, win32print, sys, os, pyautogui, json
...
root = tk.Tk()
p_info = read_data()
app = Ky(root,p_info['name'],p_info['gender'],p_info['age'],p_info['weight'])
root.mainloop()
...
pyautogui.alert(text=str(text_show),
                title=str(app.name)+' '+str(app.age)+'岁 '+str(app.weight)+'kg:')
